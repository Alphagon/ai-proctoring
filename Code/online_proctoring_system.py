    ...
    if frame_count % 5 == 0:
        ...
        try:
            ...
            if(count_items['person'] > 0):
                ...
                headpose_detection_frames, frame3, headpose_condition = head_pose_detection(h_model, frame2, frame3, face, headpose_detection_frames, 
                                                                                            frame_count, fps, report, debug=DEBUG)
